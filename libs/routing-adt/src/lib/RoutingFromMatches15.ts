...
export const routingFromMatches15 = <
  O,
  N,
  M,
  L,
...
N & { type: NKey } | M & { type: MKey } | L & { type: LKey } | K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | O & { type: OKey }
  format: (adt: { type: 'NotFound' } | 
N & { type: NKey } | M & { type: MKey } | L & { type: LKey } | K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | O & { type: OKey }) => string;
  adt: ADT<{ type: 'NotFound' } | 
N & { type: NKey } | M & { type: MKey } | L & { type: LKey } | K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | O & { type: OKey }, 'type'>
} => {
...
{ type: NKey } | { type: MKey } | { type: LKey } | { type: KKey } | { type: JKey } | { type: IKey } | { type: HKey } | { type: GKey } | { type: FKey } | { type: EKey } | { type: DKey } | { type: CKey } | { type: BKey } | { type: AKey } | { type: OKey }, "type">
  const format = (
    adt: RouteAdt
  ): string => {
