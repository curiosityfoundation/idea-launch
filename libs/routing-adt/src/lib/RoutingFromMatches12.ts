...
K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | L & { type: LKey }
  format: (adt: { type: 'NotFound' } | 
K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | L & { type: LKey }) => string;
  adt: ADT<{ type: 'NotFound' } | 
K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | L & { type: LKey }, 'type'>
} => {
...
{ type: KKey } | { type: JKey } | { type: IKey } | { type: HKey } | { type: GKey } | { type: FKey } | { type: EKey } | { type: DKey } | { type: CKey } | { type: BKey } | { type: AKey } | { type: LKey }, "type">
  const format = (
    adt: RouteAdt
  ): string => {
