...
L & { type: LKey } | K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | M & { type: MKey }
  format: (adt: { type: 'NotFound' } | 
L & { type: LKey } | K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | M & { type: MKey }) => string;
  adt: ADT<{ type: 'NotFound' } | 
L & { type: LKey } | K & { type: KKey } | J & { type: JKey } | I & { type: IKey } | H & { type: HKey } | G & { type: GKey } | F & { type: FKey } | E & { type: EKey } | D & { type: DKey } | C & { type: CKey } | B & { type: BKey } | A & { type: AKey } | M & { type: MKey }, 'type'>
} => {
...
{ type: LKey } | { type: KKey } | { type: JKey } | { type: IKey } | { type: HKey } | { type: GKey } | { type: FKey } | { type: EKey } | { type: DKey } | { type: CKey } | { type: BKey } | { type: AKey } | { type: MKey }, "type">
  const format = (
    adt: RouteAdt
  ): string => {
